...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div class="card mt-4 mx-auto" style="width: 46rem">
        ...
        <h3 class="mt-4 text-center">Add New Article</h3>
        ...
        <div class="card-body text-center">            
            <form class="text-center p-3"  runat="server">
                ...
                <div class="mt-2 text-left">
                    ...
                    <br />
                    <asp:Label ID="Label5" class="float-left text-info" runat="server" Text="Default Image will be given if no file is chosen. "></asp:Label>
                </div>
