...
namespace FinTrack.DAL
{
    public class ArticleDAO
    {
        ...
        public int UpdateById(string id, string title, string description, string image, string link, string lastupdated)
        {
            string DBConnect = ConfigurationManager.ConnectionStrings["ConnStr"].ConnectionString;
            SqlConnection myConn = new SqlConnection(DBConnect);

            string sqlStmt = "UPDATE Article SET title = @paratitle, description = @paradescription, image = @paraimage, " +
